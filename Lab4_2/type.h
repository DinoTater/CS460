...
COMMANDTABLE commands[] = {
	...
	{ 'c', "Fork Custom", do_kforkcustom, "Forks a new process from the free processes with a custom image." },
	{ 'q', "Kill", do_exit, "Makes the running PROC die." },
	{ 'p', "PrintProcs", kps, "Print pid, ppid, and status of all processes." },
